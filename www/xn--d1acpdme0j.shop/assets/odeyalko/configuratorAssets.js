...
(function () {
  ...
  var FRAMES = {
    ...
    B01: { src: BASE + 'B01.jpg', d: 'pink',  p: 'green', s: 'pink',  st: 'fitted' },
    B02: { src: BASE + 'B02.jpg', d: 'cream', p: 'blue',  s: 'blue',  st: 'flat'   },
    B03: { src: BASE + 'B03.jpg', d: 'olive', p: 'olive', s: 'cream', st: 'flat'   }, /* мастер для G_mint */
    B04: { src: BASE + 'B04.jpg', d: 'pink',  p: 'pink',  s: 'blue',  st: 'fitted' },
    B05: { src: BASE + 'B05.jpg', d: 'coffee',p: 'coffee',s: 'cream', st: 'fitted' },
    B06: { src: BASE + 'B06.jpg', family: true },
    G_blue: { src: BASE + 'G_blue.jpg', d: 'blue',  p: 'blue',  s: 'cream', st: 'flat' },
    G_grey: { src: BASE + 'G_grey.jpg', d: 'white', p: 'white', s: 'cream', st: 'flat' },
    G_mint: { src: BASE + 'G_mint.jpg', d: 'green', p: 'green', s: 'cream', st: 'flat' },
  ...
  function beddingFrame(view) {
    /* view: {family, duvetOn, duvetColor, pillowOn, pillowColor, sheetOn, sheetColor, sheetType} */
    ...
    for (var i = 0; i < ids.length; i++) {
      ...
      if (view.pillowOn && f.p === view.pillowColor) score += (view.duvetOn ? 4 : 8);
